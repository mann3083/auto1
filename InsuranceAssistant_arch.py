...
class InsuranceAssistant:
    ...
    def extract_PII_Japanese_Text_ENG(self, japText):
        ...
        try:
            ...
            chat = ChatOpenAI(
                model="gpt-4o-mini", api_key=self.O_API_KEY, temperature=0.1
            )
            chat_template = ChatPromptTemplate.from_messages(prompt_and_context)
            ...
            prompt_and_context = [
                (
                    ...
                    """You are an expert extraction algorithm.
                       Only extract relevant information from the text - such as name,date,number
                    ...
                    6. **Medical Procedure Extraction**:
                    - Sentence: "Cataract Surgery happened on the left eye"
                    "Cataract Surgery happened on the left eye"
                    ...
                    If a medical condition or operation or procedure is mentioned only return
                    the medical condition or procedure - think step by step. 
